...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-24 pb-12 overflow-hidden">
      ...
      <div
        className="absolute top-1/2 left-1/4 -translate-y-1/2 w-[600px] h-[600px] bg-[#22D3EE]/20 rounded-full blur-[100px] mix-blend-screen"
      ...
      <div className="container mx-auto px-6 relative z-10 grid lg:grid-cols-2 gap-16 items-center">
        ...
        >
          <div className="inline-flex items-center px-3 py-1.5 rounded-full border border-white/10 bg-white/5 backdrop-blur-md mb-8">
            <Image src={'/logo.svg'} alt="Logo" width={24} height={24} />
            <span className="text-sm font-medium text-[#E4E4E7]">
              RepoScribe AI is now live
            </span>
          </div>

          <h1 className="text-5xl lg:text-7xl font-bold tracking-tight mb-6 leading-tight">
            Turn Any GitHub Repository Into a{" "}
            <span className="text-gradient">Stunning README.</span>
          </h1>

          <p className="text-lg text-muted mb-10 max-w-xl leading-relaxed">
            Paste your GitHub repository URL and let AI analyze your project to
            generate a polished, professional README in seconds.
          </p>
          ...
          <div className="glass rounded-2xl overflow-hidden border border-white/10 shadow-2xl relative z-10">
            ...
            <div className="p-6 bg-[#09090B]/80 font-mono text-sm">
              ...
              <div className="space-y-3">
                ...
                >
                  <span className="text-[#A855F7]">{">"}</span> Analyzing
                ...
                <motion.div
                  ...
                  className="flex items-center gap-2 text-[#A1A1AA]"
                >
                  <span className="text-[#A855F7]">{">"}</span> Detecting
                  frameworks:{" "}
                ...
                <motion.div
                  ...
                  className="flex items-center gap-2 text-[#A1A1AA]"
                >
                  <span className="text-[#A855F7]">{">"}</span> Generating
                  documentation...
                </motion.div>
                <motion.div
                  initial={{ opacity: 0, y: 10 }}
                ...
                >
                  <Sparkles className="w-4 h-4" /> README.md successfully
                  generated!
                </motion.div>
              </div>
            </div>
